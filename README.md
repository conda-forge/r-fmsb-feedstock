...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-fmsb-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7986&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-fmsb-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-fmsb` can be installed with:

```
conda install r-fmsb
```

It is possible to list all of the versions of `r-fmsb` available on your platform with:
